    ...
    public class CrmInsertTest : WorkflowTestBase
    {
        ...
        public void CrmInsertTest_Fails_When_Invalid_JSON()
        {
            ...
            using (ITestRunner testRunner = CreateTestRunner(settingsToOverride))
            {
                ...
                // Check tracked properties
                var trackedProps = testRunner.GetWorkflowActionTrackedProperties("Parse_JSON");
                var expectedBody = "{\"sbi2\":12345678,\"frn2\":123456789,\"apiLink2\":\"https://myStatementRetrievalApiEndpoint/statement-receiver/statement/v1/FFC_PaymentStatement_SFI_2022_1234567890_2022090615023001.pdf\",\"documentType2\":\"Payment statement\",\"scheme2\":\"SFI\"}";
                Assert.AreEqual(expectedBody, trackedProps["messageBody"]);
            }
        }
